                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Create Acadamic Record</h4>
                            <a class="btn btn-primary text-right" href="{{ route('academics.index') }}">Academic Records</a>
                        </div>
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <form action="{{ route('academics.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        {{-- @foreach ($distinctValues as $field => $values)
                                            <div class="col-lg-6 mb-2">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control custom-select" name="{{ $field }}"
                                                        ...
                                                        @endforeach
                                                        <option value="custom"
                                                            {{ old($field) == 'custom' ? 'selected' : '' }}>
                                                            Enter Custom
                                                        </option>
                                                    </select>
                                                    <input type="text" class="form-control custom-input"
                                                        name="custom_{{ $field }}"
                                                        placeholder="Custom {{ ucfirst($field) }}"
                                                        style="{{ old($field) == 'custom' ? '' : 'display: none;' }}"
                                            ...
                                            <div class="col-lg-6 mb-2">
                                                ...
                                                <div class="input-group">
                                                    <select
                                                        ...
                                                        @foreach ($values as $value)
                                                            <option value="{{ $value }}"
                                                                @if (old($field) == $value) selected @endif>
                                                                {{ $value }}</option>
                                                        @endforeach
                                                        ...
                                                        @if (isset($distinctValues[$field]) && is_array($distinctValues[$field]))
                                                            @foreach ($distinctValues[$field] as $distinctValue)
                                                                <option value="{{ $distinctValue }}"
                                                                    @if (old($field) == $distinctValue) selected @endif>
                                                                    {{ $distinctValue }}</option>
                                                            @endforeach
                                                        @endif
                                                        <option value="custom"
                                                            @if (old($field) == 'custom') selected @endif>Enter Custom
                                                        </option>
                                                    </select>
                                                    <input type="text" class="form-control custom-input"
                                                        name="custom_{{ $field }}"
