...
@section('headerTitle', 'E Resource')
            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{ asset('build/assets/img/home/1I6A9223.JPG') }}" class="d-block w-100" alt="...">
                    ...
                    <div class="carousel-item">
                        <img src="{{ asset('build/assets/img/home/IMG_3464.JPG') }}" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                    ...
                    <div class="carousel-item">
                        <img src="{{ asset('build/assets/img/home/IMG_3501.JPG') }}" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="owl-carousel owl-carousel owl-loaded front-view-slider">
                        ...
                        <div class="items">
                            <div class="review-box card">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('build/assets/images/courses/pic3.jpg') }}" alt="">
                                    <div class="ms-3">
                                        <h4 class="mb-0 fs-18 font-w500">Karen Hope</h4>
                                        <ul class="d-flex align-items-center raiting my-0">
                                            <li><i class="fas fa-star star-orange"></i>
                        ...
                        <div class="items">
                            <div class="review-box card">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('build/assets/images/courses/pic4.jpg') }}" alt="">
                                    <div class="ms-3">
                                        <h4 class="mb-0 fs-18 font-w500">Karen Hope</h4>
                                        <ul class="d-flex align-items-center raiting my-0">
                                            <li><i class="fas fa-star star-orange"></i>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div
                                        class="widget-courses align-items-center d-flex justify-content-between flex-wrap">
                                        <div class="d-flex align-items-center flex-wrap">
                                            <img src="{{ asset('build/assets/images/svg/microscope.svg') }}"
                                                alt="">
                                            <div class="flex-1 ms-3">
                                                <h4>Science</h4>
                                                <span>Lorem ipsum dolor</span>
