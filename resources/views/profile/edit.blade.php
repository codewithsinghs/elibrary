						...
						<div class="card instructors-box">
							...
							<div class="card-body text-center pb-3">
								<div class="instructors-media">
									<img src="{{ asset(Storage::url('users/thumbnails/' . ($user->profile->image ?: 'no_image.png'))) }}" alt="User Image">
                                    
                                    {{-- <img src="{{ asset(Storage::exists('public/users/thumbnails/' . $user->profile->image) ? Storage::url('users/thumbnails/' . $user->profile->image) : Storage::exists('public/users/' . $user->profile->image) ? Storage::url('users/' . $user->profile->image) : Storage::url('users/thumbnails/no_image.png')) }}" alt="User Image"> --}}
									<div class="instructors-media-info mt-4">
										<h4 class="mb-1">{{ $user->name }}</h4>
										<span class="fs-18">Member Since {{ $user->profile->year_of_admission ?? $user->profile->joining_date ?? $user->created_at->format('d-M-Y')}}</span>
								...
								<div class="achievements ">
									...
									<div class="achievements-content flex-wrap">
										<span><img src="{{ asset('build/assets') }}/images/svg/cup.svg"  alt=""></span>
										<span><img src="{{ asset('build/assets') }}/images/svg/puzzle.svg" alt=""></span>
										<span><img src="{{ asset('build/assets') }}/images/svg/planet.svg" alt=""></span>
										<span><img src="{{ asset('build/assets') }}/images/svg/skill.svg" alt=""></span>
										<span><img src="{{ asset('build/assets') }}/images/svg/readingtime.svg" alt=""></span>
									</div>	
								</div>
