                            ...
                            {{-- <div class="nav-item d-flex d-none d-xl-block d-lg-block d-md-block   mx-5">
                                ...
                                <ul class="nav metismenu font-medium mr-5">
                                    <li class="nav-item @active('/')">
                                        <a class="nav-link " href="{{ url('/') }}"><span class="nav-text">Home</span></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ url('/about') }}"><span class="nav-text">About</span></a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <div class="navbar-nav header-right">
                            <div class="nav-item d-flex align-items-center">
                                ...
                                @guest
                                    ...
                                    <a class="nav-link" href="{{ route('login') }}">Login <i class="bi bi-box-arrow-right"></i></a>
                                @else
