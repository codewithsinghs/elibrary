    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            ...
            <div class="widget-heading d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('resources') }}" class="btn btn-primary btn-sm">View all</a>
            </div>
            <div class="row">
                                    ...
                                    <div class="card-body">
                                        <div class="widget-courses align-items-center d-flex justify-content-between flex-wrap">
                                            <div class="d-flex align-items-center flex-wrap">
                                                <img src="{{ asset('build/assets/images/svg/color-palette.svg') }}" alt="">
                                                <div class="flex-1 ms-3">
                                                    <h4>{{ $category }}</h4>
                                                    <span>Resources</span>
                                                </div>
                                            </div>
                                            <a href="{{ route('resources', ['category' => $category]) }}"><i class="las la-angle-right text-primary"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            {{-- <li><a href="{{ route('resources.index', ['category' => $category]) }}" target="_blank">{{ $category }}</a></li> --}}
                        @endforeach
                        {{-- <div class="swiper-slide">
                            <div class="card">
                                <div class="card-body">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <div class="card-body">
                                    <div class="widget-courses align-items-center d-flex justify-content-between flex-wrap">
                                        <div class="d-flex align-items-center flex-wrap">
                                            <img src="{{ asset('build/assets/images/svg/education-website.svg') }}"
                                                alt="">
                                            <div class="flex-1 ms-3">
                                                <h4>Coading</h4>
                                                <span>Lorem ipsum dolor</span>
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <div class="card-body">
                                    <div class="widget-courses align-items-center d-flex justify-content-between flex-wrap">
                                        <div class="d-flex align-items-center flex-wrap">
                                            <img src="{{ asset('build/assets/images/svg/brain.svg') }}" alt="">
                                            <div class="flex-1 ms-3">
                                                <h4>Soft Skill</h4>
                                                <span>Lorem ipsum dolor</span>
                                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <div class="card-body">
                                    <div class="widget-courses align-items-center d-flex justify-content-between flex-wrap">
                                        <div class="d-flex align-items-center flex-wrap">
                                            <img src="{{ asset('build/assets/images/svg/microscope.svg') }}" alt="">
                                            <div class="flex-1 ms-3">
                                                <h4>Science</h4>
                                                <span>Lorem ipsum dolor</span>
                                            </div>
            ...
            <div class="widget-heading d-flex justify-content-between align-items-center">
                <h3 class="m-0">All Resourrces</h3>
                            ...
                            <div class="card-body">
                                <div class="courses-bx">
                                    <div class="dlab-media">
                                        {{-- <img src="{{ asset('build/assets/images/courses/course1.jpg') }}" alt=""> --}}
                                        <img src="{{ Storage::url('resources/' . $resource->image) }}" alt="">
                                    </div>
                                    <div class="dlab-info">
                                        <div class="dlab-title d-flex justify-content-between">
                                            <div>
                                                <h4><a href="{{ route('resources.view', $resource->slug) }}">{{ $resource->name }}</a></h4>
                                                <p class="m-0">{{ $resource->caption }}
                                            ...
                                            <h4 class="text-primary">{{ $resource->author }}</h4>
                                        </div>
                                        <div class="d-flex justify-content-between content align-items-center">
                                            ...
                                            <a href="{{ route('resources.view', $resource->slug) }}" class="btn btn-primary btn-sm">View all</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="card all-crs-wid">
                        <div class="card-body">
                            <div class="courses-bx">
                                <div class="dlab-media">
                                    <img src="{{ asset('build/assets/images/courses/course2.jpg') }}" alt="">
                                </div>
                                <div class="dlab-info">
                                    <div class="dlab-title d-flex justify-content-between">
                                        <div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="card all-crs-wid">
                        <div class="card-body">
                            <div class="courses-bx">
                                <div class="dlab-media">
                                    <img src="{{ asset('build/assets/images/courses/course3.jpg') }}" alt="">
                                </div>
                                <div class="dlab-info">
                                    <div class="dlab-title d-flex justify-content-between">
                                        <div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="card all-crs-wid">
                        <div class="card-body">
                            <div class="courses-bx">
                                <div class="dlab-media">
                                    <img src="{{ asset('build/assets/images/courses/course4.jpg') }}" alt="">
                                </div>
                                <div class="dlab-info">
                                    <div class="dlab-title d-flex justify-content-between">
                                        <div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="card all-crs-wid">
                        <div class="card-body">
                            <div class="courses-bx">
                                <div class="dlab-media">
                                    <img src="{{ asset('build/assets/images/courses/course5.jpg') }}" alt="">
                                </div>
                                <div class="dlab-info">
                                    <div class="dlab-title d-flex justify-content-between">
                                        <div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="card all-crs-wid">
                        <div class="card-body">
                            <div class="courses-bx">
                                <div class="dlab-media">
                                    <img src="{{ asset('build/assets/images/courses/course6.jpg') }}" alt="">
                                </div>
                                <div class="dlab-info">
                                    <div class="dlab-title d-flex justify-content-between">
                                        <div>
            ...
            {{-- <div class="pagination-down">
                <div class="d-flex align-items-center justify-content-between flex-wrap">
                    <h4 class="sm-mb-0 mb-3">
                        Showing <span>{{ $resources->firstItem() }}-{{ $resources->lastItem() }}</span> from
                        <span>{{ $resources->total() }}</span> data
                    </h4>
                    <ul>
                        @if ($resources->onFirstPage())
                            <li><a href="javascript:void(0);"><i class="fas fa-chevron-left"></i></a></li>
                        @else
                            <li><a href="{{ $resources->previousPageUrl() }}"><i class="fas fa-chevron-left"></i></a></li>
                        @endif

                        @foreach ($resources->getUrlRange(1, $resources->lastPage()) as $page => $url)
                            <li><a href="{{ $url }}"
                                    class="{{ $page == $resources->currentPage() ? 'active' : '' }}">{{ $page }}</a>
                            </li>
                        @endforeach

                        @if ($resources->hasMorePages())
                            <li><a href="{{ $resources->nextPageUrl() }}"><i class="fas fa-chevron-right"></i></a></li>
                        @else
            ...
            {{-- {{ $resources->links() }} --}}
            @include('partials.pagination', ['paginator' => $resources])
            {{-- <div class="pagination-down">
                <div class="d-flex align-items-center justify-content-between flex-wrap">
