                        ...
                        <div class="card-body">
                            <div class="course-content d-flex justify-content-between flex-wrap">
                                ...
                                <div class="mt-2">
                                    ...
                                    <h4 class="text-primary mt-2">Price : ₹ <span> 512.82 </span></h4>
                                </div>
                            </div>
                            <div class="video-img style-1">
                                <div class="view-demo">
                                    @php
                                        $imageExists =
                                            $course->image &&
                                            Storage::disk('public')->exists('courses/' . $course->image);
                                        $thumbnailExists =
                                            $course->image &&
                                            Storage::disk('public')->exists('courses/thumbnails/' . $course->image);
                                    @endphp
                                ...
                                <nav>
                                    <div class="nav nav-tabs tab-auto" id="nav-tab" role="tablist">
                                        ...
                                        <button class="nav-link " id="nav-discussion-tab" data-bs-toggle="tab"
                                            ...
                                            aria-controls="nav-discussion" aria-selected="false">Discussion</button> --}}
                                    </div>
                                </nav>
                                        ...
                                        <div class="about-content">
                                            ...
                                            <script>
                                                document.getElementById('share-btn').addEventListener('click', function() {
                                                    ...
                                                    var shareUrl = "{{ route('courses.view', ['course' => $course->slug]) }}";
                                            
                                                    // Open share modal or initiate share functionality
                                                    shareCourse(shareUrl);
                                                });
                                            
                                                // Function to open share modal or initiate share functionality
                                                function shareCourse(shareUrl) {
                                                    // Check if navigator.share is supported (for modern browsers)
                                                    if (navigator.share) {
                                                        navigator.share({
                                                        ...
                                                        // Open a modal or display sharing options
                                                        // Example: Display social media sharing icons/buttons
                                                        // Example: Display email sharing form
                                                        // Example: Display copyable shareable link
                                                        // Add additional sharing options as needed
                                                        alert('Sharing options will be displayed here.');
                                                    }
                                                }
                                            </script>
                                        </div>
                    ...
                    <div class="card h-auto">
                        ...
                        <div class="card-body pt-0">
                            <div class="progress-box">
                                <div class="progress ">
                                    <div class="progress-bar bg-primary" style="width:15%; height:12px; border-radius:4px;"
                                        role="progressbar"></div>
                                </div>

                                <div class="d-flex align-items-center justify-content-between">
                                    <h5 class="mb-0 fs-14 font-w600">{{ $course->name }}</h5>
