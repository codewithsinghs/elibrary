                                            ...
                                            <div class="col-12">
                                                <div class="right-box-padding">
                                                    ...
                                                    <div class="read-content">
                                                            ...
                                                            <div class="clearfix mb-3">
                                                                ...
                                                                {{-- <a href="javascript:void(0);"
                                                                    class="btn btn-primary px-3 my-1 light me-2"><i
                                                                        ...
                                                                        <form action="{{ route('support-tickets.destroy', $ticket->ticket_id) }}" method="POST">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <button type="submit" class="btn btn-danger">Delete</button>
                                                                        </form> --}}
                                                                        <form action="{{ route('support-tickets.destroy', $supportTicket->ticket_id) }}" method="POST" style="display: inline;">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <button type="submit" class="btn btn-primary px-3 my-1 light me-2" onclick="return confirm('Are you sure you want to delete this ticket?')">
                                                            ...
                                                            @foreach ($conversation as $message)
                                                                <div class="message">
                                                                    <div class="message-info">
                                                                        ...
                                                                        <span
                                                                            class="message-timestamp">{{ $message['timestamp'] }}</span></strong>
                                                                    </div>
                                                        ...
                                                        <form
                                                            action="{{ route('support-ticket.reply', $supportTicket->ticket_id) }}"
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <label class="dropzone dlab-clickable w-100"
                                                                    id="dropzone">
                                                                    <div class="dlab-message ">Click here to upload files
                                                                    </div>
