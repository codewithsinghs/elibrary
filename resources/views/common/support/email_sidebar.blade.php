<div class="email-left-box mb-md-5 mb-4">
    <div class="p-0">
        <a href="{{route('support.create')}}" class="btn btn-primary btn-block">Compose</a>
    </div>
    <div class="mail-list rounded mt-4">
        <a href="{{ route('support.index') }}" class="list-group-item active">
            <i class="fa fa-inbox font-18 align-middle me-2"></i> Inbox
            <span class="badge badge-primary badge-sm float-end"></span>
        </a>
        <a href="{{ route('support.index-open')}}" class="list-group-item">
        ...
        <a href="javascript:void(0);" class="list-group-item">
            ...
            <span class="badge badge-circle badge-danger badge-sm text-white float-end"></span>
        </a>
        <a href="javascript:void(0);" class="list-group-item">
